...
(function() {
    ...
    // XPath for the first submit button (updated as per your request)
    const firstButtonXPath = '/html/body/main/main/div/div/div[2]/div[2]/button';

    // Set a random delay (between 2 and 5 seconds) for the first button click
    const delay = Math.random() * 200 + 100; // Random delay between 2 and 5 seconds

    // Click the first button using XPath after the random delay
    clickButtonWithDelay(firstButtonXPath, delay);
